...
class Filters // : Effect
{
  ...
  private:
    ...
    void init(int sr)
    {
      ...
      for (int i = 0; (i < 2); i = (i + 1)) { fRec4[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec3[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec2[i] = 0.f; }
      for (int i = 0; (i < 2); i = (i + 1)) { fRec5[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec1[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec0[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec9[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec8[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec7[i] = 0.f; }
      for (int i = 0; (i < 3); i = (i + 1)) { fRec6[i] = 0.f; }
    }
};
