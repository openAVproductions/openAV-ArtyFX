...
#ifndef OPENAV_BIQUAD_H
#define OPENAV_BIQUAD_H

// Adapted from biquad implementation by Tom St Denis, thanks!
// Retrieved from http://www.musicdsp.org/showone.php?id=64
