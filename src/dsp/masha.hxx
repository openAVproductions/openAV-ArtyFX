...
typedef enum {
	...
	MASHA_BPM_FROM_HOST, // Toggle BPM from transport or manual
	MASHA_BPM_MANUAL,    // Manual BPM control
} MashaPortIndex;
...
public:
	...
	float* controlDryWet;
	float* controlActive;
	float* controlBpmFromHost;
	float* controlBpmManual;
	...
	void setUnmap( LV2_URID_Unmap* um ) { unmap = um; }
